...
<body class="bg-gradient-to-r from-blue-100 to-blue-200">
    <div class="flex">
        ...
        <div class="w-5/6 p-6">
            ...
            <div class="mb-4">
                <a href="{{ route('foto.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">
                    Tambah Foto
                </a>
            </div>
            ...
            <table class="min-w-full bg-white border border-gray-200">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="py-2 px-4 border-b">{{ $foto->id }}</td>
                        <td class="py-2 px-4 border-b">{{ $foto->galery_id }}</td>
                        <td class="py-2 px-4 border-b">{{ $foto->judul }}</td>
