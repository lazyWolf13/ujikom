        ...
        <main class="w-5/6 p-6">
            ...
            <section class="bg-white p-6 rounded-lg shadow mb-6">
                ...
                <div class="grid grid-cols-3 gap-4">
                    @foreach(App\Models\Kategori::withCount('posts')->get() as $kategori)
                    <div class="bg-gray-100 p-4 rounded-lg">
                        <div class="text-lg font-semibold">{{ $kategori->judul }}</div>
                        <div class="text-2xl font-bold text-blue-600">{{ $kategori->posts_count }}</div>
