    ...
    <div class="flex">
        ...
        <div class="w-5/6 p-6">
            ...
            <div class="mb-4 flex items-center justify-between">
                ...
                <form action="{{ route('galery.index') }}" method="GET" class="flex gap-2">
            ...
            <table class="min-w-full bg-white border border-gray-200">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="py-2 px-4 border-b">{{ $galery->id }}</td>
                        <td class="py-2 px-4 border-b">{{ $galery->post->judul }}</td>
                        <td class="py-2 px-4 border-b">{{ $galery->position }}</td>
                        <td class="py-2 px-4 border-b">{{ $galery->status }}</td>
