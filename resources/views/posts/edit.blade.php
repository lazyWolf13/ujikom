    ...
    <div class="bg-white p-8 rounded-lg shadow-xl w-96">
        ...
        <form action="{{ route('posts.update', $post->id) }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="judul" id="judul" value="{{ old('judul', $post->judul) }}" required
            ...
            <div class="mb-6">
                ...
                <select name="kategori_id" id="kategori_id" required
                    ...
                    <option value="{{ $cat->id }}" {{ $cat->id == $post->kategori_id ? 'selected' : '' }}>
                        {{ $cat->judul }}
                    </option>
                    @endforeach
                </select>
            ...
            <div class="mb-6">
                ...
                <textarea name="isi" id="isi" rows="4" required
                    class="w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('isi', $post->isi) }}</textarea>
            </div>
