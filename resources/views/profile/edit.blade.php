    ...
    <div class="bg-white p-8 rounded-lg shadow-xl w-96">
        ...
        <form action="{{ route('profile.update', $profile->id) }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text" id="judul" name="judul" value="{{ old('judul', $profile->judul) }}" required
            ...
            <div class="mb-6">
                ...
                <textarea id="isi" name="isi" required rows="4"
                    class="w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('isi', $profile->isi) }}</textarea>
            </div>
