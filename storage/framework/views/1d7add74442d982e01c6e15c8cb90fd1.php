            ...
            <table class="min-w-full bg-white">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="py-2 px-4 border-b"><?php echo e($category->judul); ?></td>
                        <td class="py-2 px-4 border-b">
                            <a href="<?php echo e(route('kategori.edit', $category->id)); ?>"
                                class="text-blue-600 hover:underline mr-2">Edit</a>
                            <form action="<?php echo e(route('kategori.destroy', $category->id)); ?>" method="POST"
...
</html><?php /**PATH C:\MyProject\schoolensa\resources\views/kategori/index.blade.php ENDPATH**/ ?>