...
<body class="bg-gradient-to-r from-indigo-200 to-blue-300 min-h-screen flex items-center justify-center">
    <div class="bg-white p-8 rounded-lg shadow-xl w-96">
        <h2 class="text-3xl font-bold text-center text-blue-600 mb-6">Edit Petugas</h2>

        <form action="<?php echo e(route('petugas.update', $petugas->id)); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\MyProject\schoolensa\resources\views/petugas/edit.blade.php ENDPATH**/ ?>