            ...
            <table class="min-w-full bg-white">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="py-2 px-4 border-b text-center"><?php echo e($p->username); ?></td>
                        <td class="py-2 px-4 border-b text-center">
                            <a href="<?php echo e(route('petugas.edit', $p->id)); ?>"
                                class="text-blue-600 hover:underline mr-4">Edit</a>
                            <form action="<?php echo e(route('petugas.destroy', $p->id)); ?>" method="POST" style="display:inline;">
                                <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\MyProject\schoolensa\resources\views/petugas/index.blade.php ENDPATH**/ ?>