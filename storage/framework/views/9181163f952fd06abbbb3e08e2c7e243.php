        ...
        <form action="<?php echo e(route('posts.store')); ?>" method="POST">
            ...
            <div class="mb-6">
                ...
                <select name="kategori_id" id="kategori_id" required
                    ...
                    <option value="<?php echo e($category->id); ?>"><?php echo e($category->judul); ?></option>
            ...
            <div class="mb-6">
                ...
                <textarea name="isi" id="isi" required rows="4"
                    class="w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500"><?php echo e(old('isi')); ?></textarea>
            </div>
...
</html><?php /**PATH C:\MyProject\schoolensa\resources\views/posts/create.blade.php ENDPATH**/ ?>