        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
            <div class="p-6">
                ...
                <p class="text-gray-600 mb-4" id="short-text-<?php echo e($post->id); ?>">
                    ...
                    <button onclick="toggleText(<?php echo e($post->id); ?>)" class="text-blue-600 hover:text-blue-700 font-medium">
                        Baca selengkapnya →
                    </button>
                </p>
        ...
        <div class="album-card" onclick="openAlbum('album-<?php echo e(Str::slug($postTitle)); ?>')">
            ...
            <div class="relative group cursor-pointer bg-white rounded-xl shadow-md overflow-hidden">
                ...
                <div class="aspect-[4/3] overflow-hidden">
                    <?php if($gallery->first() && file_exists(storage_path('app/public/' . $gallery->first()->file))): ?>
                    <img src="<?php echo e(asset('storage/' . $gallery->first()->file)); ?>" alt="<?php echo e($postTitle); ?>"
                        class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                    <?php else: ?>
                    <img src="<?php echo e(asset('images/default-image.jpg')); ?>" alt="default image"
                        class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                    <?php endif; ?>
                    <!-- Overlay -->
                    <div
                    ...
                    <div class="relative max-w-7xl mx-auto">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                            ...
                            <div class="group relative aspect-square overflow-hidden rounded-lg cursor-pointer"
                                ...
                                <?php if(file_exists(storage_path('app/public/photos/' . $foto->file))): ?>
            ...
            <div class="border-t border-gray-700 pt-8">
                <div class="flex flex-col md:flex-row justify-between items-center">
                    ...
                    <p class="text-gray-400 text-sm">
                        &copy; <?php echo e(date('Y')); ?> Syaziliya. All Rights Reserved.
                    </p>
                </div>
            </div>
        </div>
...
</html><?php /**PATH C:\schoolensa\resources\views/welcome.blade.php ENDPATH**/ ?>