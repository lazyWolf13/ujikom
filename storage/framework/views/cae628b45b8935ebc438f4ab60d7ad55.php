...
<body class="bg-gradient-to-r from-indigo-200 to-blue-300 min-h-screen flex items-center justify-center">
    <div class="bg-white p-8 rounded-lg shadow-xl w-96">
        <h2 class="text-3xl font-bold text-center text-blue-600 mb-6">Edit Post</h2>
        ...
        <form action="<?php echo e(route('posts.update', $post->id)); ?>" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="judul" id="judul" value="<?php echo e(old('judul', $post->judul)); ?>" required
            ...
            <div class="mb-6">
                ...
                <select name="kategori_id" id="kategori_id" required
                    ...
                    <option value="<?php echo e($cat->id); ?>" <?php echo e($cat->id == $post->kategori_id ? 'selected' : ''); ?>>
                        <?php echo e($cat->judul); ?>
            ...
            <div class="mb-6">
                ...
                <textarea name="isi" id="isi" rows="4" required
                    class="w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500"><?php echo e(old('isi', $post->isi)); ?></textarea>
            </div>
...
</html><?php /**PATH C:\MyProject\schoolensa\resources\views/posts/edit.blade.php ENDPATH**/ ?>