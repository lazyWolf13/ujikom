    ...
    <body class="bg-gradient-to-r from-blue-100 to-blue-300">
        ...
        <div class="flex justify-center items-center min-h-screen p-6">
            <div class="w-full max-w-lg bg-white p-10 rounded-lg shadow-lg">
                ...
                <form action="<?php echo e(route('kategori.update', $category->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>

                    <div class="mb-6">
                        <label for="judul" class="block text-sm font-medium text-gray-700">Judul Kategori</label>
                        <input type="text" name="judul" id="judul" value="<?php echo e($category->judul); ?>"
    ...
    </html><?php /**PATH C:\MyProject\schoolensa\resources\views/kategori/edit.blade.php ENDPATH**/ ?>